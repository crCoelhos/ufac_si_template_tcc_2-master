...
% ADDED: italização do et al nas referencias
...
% NOVAS ADIÇÕES
\usepackage{pgfplots, pgfplotstable} %plotagem de dados: https://pt.overleaf.com/learn/latex/Pgfplots_package
%
...
% TODO: VALIDAR
\orientador{Nome Completo do Orientador}    % redefinido no abntex2-UFAC para aceitar Instituição (default = UFAC)
\orientadora{Nome Completo da Orientadora}    % redefinido no abntex2-UFAC para aceitar Instituição (default = UFAC)
